          ...
          children: [
            InkWell(
              child: Icon(
                Icons.home,
                size: routeName == 'home'
                    ? decoration.theme(context).textTheme.headline1!.fontSize
                    : decoration.theme(context).textTheme.headline2!.fontSize,
                color: routeName == 'home'
                    ? decoration.theme(context).focusColor
            ...
            InkWell(
              child: Icon(
                Icons.info,
                size: routeName == 'about'
                    ? decoration.theme(context).textTheme.headline1!.fontSize
                    : decoration.theme(context).textTheme.headline2!.fontSize,
                color: routeName == 'about'
                    ? decoration.theme(context).focusColor
                    : decoration.theme(context).backgroundColor,
              ),
